 ...
 <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="social-links d-none d-md-block">
        ...
        <a href="https://www.facebook.com/profile.php?id=100090712870631&mibextid=uzlsIk" class="facebook"><i class="bi bi-facebook"></i></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Les Générations</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            <li class="dropdown"><a href="#"><span>2007-2010</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2007</a></li>
                  <li><a href="#">2008</a></li>
                  <li><a href="#">2009</a></li>
              ...
              <li class="dropdown"><a href="#"><span>2010-2013</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2010</a></li>
                  <li><a href="#">2011</a></li>
                  <li><a href="#">2012</a></li>
              ...
              <li class="dropdown"><a href="#"><span>2013-2016</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2013</a></li>
                  <li><a href="#">2014</a></li>
                  <li><a href="#">2015</a></li>
              ...
              <li class="dropdown"><a href="#"><span>2016-2019</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2016</a></li>
                  <li><a href="#">2017</a></li>
                  <li><a href="#">2018</a></li>
              ...
              <li class="dropdown"><a href="#"><span>2019-2022</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2019</a></li>
                  <li><a href="#">2020</a></li>
                  <li><a href="#">2021</a></li>
              ...
              <li class="dropdown"><a href="#"><span>2022-2025</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">2022</a></li>
                  <li><a href="#">2023</a></li>
                  <li><a href="#">2024</a></li>
